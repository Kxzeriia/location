...
function CMenu:stringsplit(inputstr, sep)
...
function CMenu:CloseMenu(bypass)
...
function CMenu:GetButtons(customMenu)
...
function CMenu:OpenMenu(stringName, boolBack)

	if stringName and not self.Menu[stringName] then print("[CMenu] " .. stringName .. " cannot be opened, the menu doesn't exist.") return end
...
function CMenu:CreateMenu(tableMenu, tempData)
...
function CMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
...
function CMenu:DrawButtons(tableButtons)
...
function CMenu:DrawHeader(intCount)
...
function CMenu:DrawHelpers(tableButtons)
...
function CMenu:DrawExtra(tableButtons)
...
function CreateMenu(arrayMenu, tempData)
	...
	return CMenu:CreateMenu(arrayMenu, tempData)
...
function OpenMenu(stringName)
	...
	return CMenu:OpenMenu(stringName)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if CMenu.IsVisible and not CMenu.Invisible then

			CMenu:ProcessControl()
